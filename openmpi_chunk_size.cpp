...
int main(int argc, char** argv) {
    ...
    const int CHUNK_SIZE = 1000000; // Updated chunk size
    ...
    for (int chunkStart = 0; chunkStart < localNumPaths; chunkStart += CHUNK_SIZE) {
        int chunkEnd = std::min(chunkStart + CHUNK_SIZE, localNumPaths);
